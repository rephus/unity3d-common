...
/**
	This is a collection of terrain/world/camera/gameobject static util methods
	used in Mobilecraft project.
	More info: http://coconauts.net/projects/starcraft-unity3d/
**/
public class Utils {
